...
namespace textbox
{
    public partial class Form1 : Form
    {
        ...
        {
            textBoxes.Add(new Textbox( ((BunifuMaterialTextbox)sender).Text, ((BunifuMaterialTextbox)sender).Name ));
            textBoxInUI.Add((BunifuMaterialTextbox)sender);

            foreach (var textbox in textBoxes)
            {
                if (((BunifuMaterialTextbox)sender).Text == textbox.Placeholder)
                {
